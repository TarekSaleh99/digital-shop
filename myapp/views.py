...
def payment_success_view(request):
    """Handles the payment success and updates order and product details."""
...
def payment_failed_view(request):
    """Displays the payment failure message."""
...
def product_edit(request, id):
    """Allows the seller to edit an existing product."""
    product = Product.objects.get(id=id)
...
def product_delete(request, id):
    """Allows the seller to delete a product."""
    product = Product.objects.get(id=id)
    if product.seller != request.user:
        return redirect('invalid')
...
def dashboard(request):
    """Displays the seller's dashboard with their products."""
...
def invalid(request):
    """Displays an invalid action error page."""
...
def sales(request):
    """Displays the sales statistics for the logged-in seller."""
